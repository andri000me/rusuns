...
@section('PageTitle', 'Hitung Tagihan Listrik')
@section('header')
<!-- Bagian Header -->
...
<div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">Hitung Tagihan Listrik</h4>
		    <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="<?= url('/home');?>">Home</a></li>
            <li class="breadcrumb-item active" aria-current="page">Listrik</li>
         </ol>
	   </div>
</div>
...
<div class="modal fade" id="addModal">
    ...
    <div class="modal-content border-secondary">
        ...
        <div class="modal-body">
            <form action=<?= url('/tagihan/hitung_listrik_create'); ?> method="post">
