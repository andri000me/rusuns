            ...
            <div class="table-responsive">
                ...
                ?>
                    <tr>
                      ...
                      <button type="button" data-toggle="modal" data-target="#edit{{$d->name}}" class="btn btn-warning btn-xs waves-effect waves-light"><i class="fa fa-edit"></i> Edit</button>
                      <!-- Modal Edit -->
                      ...
                      <a href="<?= url('permission/delete/'.$d->access_id);?>" class="btn btn-danger btn-xs waves-effect waves-light"><i class="fa fa-trash"></i> Delete</a>
                      <?php } ?>
                      </td>
                    </tr>
                    <?php endforeach;?>
